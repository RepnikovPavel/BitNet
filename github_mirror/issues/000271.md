# issue #271: ggml_compute_forward_soft_max_f32 assertion failed

- state: open
- author: @GuillaumeRattin
- created_at: 2025-05-16T18:46:35Z
- updated_at: 2026-03-30T03:36:30Z
- url: https://github.com/microsoft/BitNet/issues/271

---

Hello, 

I am following the root README, I've managed to compile the sources. When I run the inference command example `python run_inference.py -m models/BitNet-b1.58-2B-4T/ggml-model-i2_s.gguf -p "You are a helpful assistant" -cnv` I get the following error during model warm-up: 

```
llama-cli: /home/rattingu/Workspace/BitNet/3rdparty/llama.cpp/ggml/src/ggml.c:14541: void ggml_compute_forward_soft_max_f32(const struct ggml_compute_params *, struct ggml_tensor *): Assertion `!isnan(wp[i])' failed.
llama-cli: /home/rattingu/Workspace/BitNet/3rdparty/llama.cpp/ggml/src/ggml.c:14541: void ggml_compute_forward_soft_max_f32(const struct ggml_compute_params *, struct ggml_tensor *): Assertion `!isnan(wp[i])' failed.
Error occurred while running command: Command '['build/bin/llama-cli', '-m', 'models/BitNet-b1.58-2B-4T/ggml-model-i2_s.gguf', '-n', '128', '-t', '2', '-p', 'You are a helpful assistant', '-ngl', '0', '-c', '2048', '--temp', '0.8', '-b', '1', '-cnv']' died with <Signals.SIGABRT: 6>.
```
...
register_device: registered device CPU (Intel(R) Core(TM) i7-3770K CPU @ 3.50GHz)
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
build: 3957 (5eb47b72) with Ubuntu clang version 18.1.3 (1ubuntu1) for x86_64-pc-linux-gnu (debug)
...
### Comment by @sunjizheng at 2025-05-23T15:26:33Z

I ran into the same issue.

### Comment by @3ynm at 2025-06-03T23:05:58Z

Same here

### Comment by @GuillaumeRattin at 2025-06-04T10:54:06Z

@sunjizheng @3ynm, what CPU are you using? I managed to run inference on an i3-7100T. 

### Comment by @vitorgamer58 at 2026-03-30T03:24:19Z

I encountered the same error in run_inference_server, but I was able to fix it by reducing the ubatch_size.

My issue: https://github.com/microsoft/BitNet/issues/517

@GuillaumeRattin @sunjizheng @3ynm 
