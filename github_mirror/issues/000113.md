# issue #113: Cannot run tl1 model on iOS

- state: open
- author: @luionTW
- created_at: 2024-11-13T08:38:59Z
- updated_at: 2024-11-22T03:14:35Z
- url: https://github.com/microsoft/BitNet/issues/113

---

Hi all,

I have tested the ggml-model-tl1.gguf (Llama3-8B-1.58-100B-tokens) model on iOS (iPhone 15 Pro) using the llamaSwiftUI sample project. However, I encountered an EXC_BAD_ACCESS error at ggml_vec_dot_f32().
Can you confirm whether BitNet models (either tl1 or i2_s format) can run on iOS devices? For reference, while the i2_s format doesn't produce this error, it generates unexpected repeated responses.

I've attached the log and screenshot for reference."

![Image](https://github.com/user-attachments/assets/f4240cbb-ef50-40f0-bbc4-0fad950a8e0c)
...
llama_model_loader: - kv  10:                          general.file_type u32              = 38
...
llama_model_loader: - type  tl1:  224 tensors
...
llm_load_print_meta: model ftype      = TL1
...
ggml_metal_init: loading '/var/containers/Bundle/Application/901F6E0A-4889-4A22-8E95-D6602F538691/llama.swiftui.app/llama_llama.bundle/default.metallib'
...
### Comment by @potassiummmm at 2024-11-21T07:48:32Z
...
### Comment by @luionTW at 2024-11-21T10:08:46Z
...
I am using m-series Mac and iPhone 15 Pro. they are all arm-architecture. 

### Comment by @luionTW at 2024-11-22T03:14:34Z

Additionally, I’ve tested both the i2_s and tl1 models on iOS, and the issue occurs with the tl1 model.

For the i2_s issue, please refer to the link below. Thank you.
[Reference Link](https://github.com/microsoft/BitNet/commit/bf11a49f11b9d0535285cc4cdec834a28762ed87#commitcomment-149027995)
