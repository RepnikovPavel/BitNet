# issue #68: Inference not working properly on x86 Ubuntu 20.04 VM while functioning correctly on M1 Pro

- state: closed
- author: @kronenz
- created_at: 2024-10-22T07:34:48Z
- updated_at: 2024-11-06T16:44:51Z
- closed_at: 2024-11-06T16:44:50Z
- url: https://github.com/microsoft/BitNet/issues/68

---

```markdown
### Environment
- Host OS: Ubuntu 20.04 (Virtual Machine, x86 architecture)
- Comparison System: M1 Pro (working correctly)
- Model: Llama3-8B-1.58-100B-tokens/ggml-model-i2_s.gguf

### Steps to Reproduce
1. Install Bitnet.app
2. Run the following command:
```bash
python run_inference.py -m models/Llama3-8B-1.58-100B-tokens/ggml-model-i2_s.gguf -p "how old are you?\nAnswer:" -n 6 -temp 0
```

### Results Comparison

#### Macbook M1 Pro 
![m1 pro Result](https://github.com/user-attachments/assets/3d4558b5-760b-451a-b3dd-88d6ef909e1c)
``` text
...
#### Virtual Host (x86)
![x86 Result](https://github.com/user-attachments/assets/80cb3482-1fd3-4f48-b105-8ad0f7c8b4c0)
``` text
(bitnet-cpp) root@opstdev:/home/forwiz/BitNet# python run_inference.py -m models/Llama3-8B-1.58-100B-tokens/ggml-model-i2_s.gguf -p "how old are you?\nAnswer:" -n 6 -temp 0
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
build: 3947 (406a5036) with clang version 10.0.0-4ubuntu1 for x86_64-pc-linux-gnu
...
llama_perf_sampler_print:    sampling time =       0.68 ms /    14 runs   (    0.05 ms per token, 20618.56 tokens per second)
llama_perf_context_print:        load time =    2711.41 ms
llama_perf_context_print: prompt eval time =    2649.38 ms /     8 tokens (  331.17 ms per token,     3.02 tokens per second)
llama_perf_context_print:        eval time =    1407.29 ms /     5 runs   (  281.46 ms per token,     3.55 tokens per second)
llama_perf_context_print:       total time =    4059.86 ms /    13 tokens
```


## Comments (2)

### Comment by @stackblogger at 2024-10-22T08:33:48Z

It works on my Ubuntu 22.04 machine though. Checkout this repository where I have incorporated it in a Node.Js socket server. Run the simple docker command to start the applications.
https://github.com/stackblogger/bitnet.js

### Comment by @Eddie-Wang1120 at 2024-10-24T08:48:16Z

@kronenz Seems your clang version is too low. I recommend you using conda if possible or updating your clang version.
